...
parser.add_argument('--board_size', default=7, type=int, help="棋盘大小")
parser.add_argument('--number', default=4, type=int, help="胜利条件：连续5子")
parser.add_argument('--n_playout', default=400, type=int, help="在选择动作前模拟多少次")
...
parser.add_argument('--check_freq', default=5, type=int, help="打印保存模型间隔")
