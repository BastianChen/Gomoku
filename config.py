...
parser.add_argument('--board_size', default=9, type=int, help="棋盘大小")
parser.add_argument('--number', default=5, type=int, help="胜利条件：连续5子")
parser.add_argument('--n_playout', default=500, type=int, help="每局自我训练模拟到终局次数")
...
parser.add_argument('--check_freq', default=30, type=int, help="打印保存模型间隔")
